...
@test Onsite([1 2; 3 4], 1) isa QBox.OnsiteConst{Int,2,Int,4}
@test Onsite(1 2; 3 4.0], 1) isa QBox.OnsiteConst{Int,2,Float64,4}
@test Onsite( @SMatrix[1 2; 3 4.0], 1) isa QBox.OnsiteConst{Int,2,Float64,4}

@test Hopping(@SMatrix[1 2.0; 3 4], (1,1)) isa QBox.HoppingConst{Tuple{Int,Int},2,2,Float64,4}
